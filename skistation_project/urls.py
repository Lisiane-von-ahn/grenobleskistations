...
urlpatterns = [
   ...
   path('bus/<int:line_id>/', views.bus_line_detail, name='bus_line_detail'),
   path('ski-partners/', views.ski_partners, name='ski_partners'),
   path('covoiturage/', views.covoiturage, name='covoiturage'),
   path('covoiturage/mes-reservations/', views.my_carpool_reservations, name='my_carpool_reservations'),
   ...
   path('ski-stories/user/<int:user_id>/decline-friend-invitation/', views.story_decline_friend_invitation, name='story_decline_friend_invitation'),
   path('ski-stories/user/<int:user_id>/cancel-friend-invitation/', views.story_cancel_friend_invitation, name='story_cancel_friend_invitation'),
   ...
   path('messages/decline-friend/', views.messages_decline_friend, name='messages_decline_friend'),
   path('messages/cancel-friend-invitation/', views.messages_cancel_friend_invitation, name='messages_cancel_friend_invitation'),
